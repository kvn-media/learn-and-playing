    ...
    def __init__(self, master=None):
        ...
        def buildWindow(self):
            ...
            def parse(fileNnme):
                ...
                graphicsCommandsElement = xmldoc.getElementByTagName("GraphicsCommands")[0]
            ...
            def loadFile():
                ...
                # calling parse will lead the graphics commands from the file.
                parse(filename)

                for cmd in self.graphicsCommands:
                    cmd.draw(theTurtle)

                # This line is necessaray to update the window after the picture is drawn.
                screen.update()
